...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg2:FlxSprite = new FlxSprite().loadGraphic(Paths.image('hotline/menu/freeplay/bg'));
		bg2.antialiasing = ClientPrefs.globalAntialiasing;
		add(bg2);
		bg2.screenCenter();
		
	var nicu:FlxSprite = new FlxSprite().loadGraphic(Paths.image('hotline/menu/freeplay/nikkuRender'));
		nicu.antialiasing = ClientPrefs.globalAntialiasing;
		add(nicu);
		nicu.screenCenter();
		
		var chapter1:FlxSprite = new FlxSprite().loadGraphic(Paths.image('hotline/menu/freeplay/chapter1'));
		chapter1.antialiasing = ClientPrefs.globalAntialiasing;
		add(chapter1);
		...
		var bars:FlxSprite = new FlxSprite().loadGraphic(Paths.image('hotline/menu/freeplay/bars'));
